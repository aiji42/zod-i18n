...
When creating a new translation file, copy `packages/zodi18n/src/laguages/en.ts` and name the file with the locale code.

After creation and customization is complete, copy `packages/zodi18n/tests/integrations/en.ts` and create a new test file.
